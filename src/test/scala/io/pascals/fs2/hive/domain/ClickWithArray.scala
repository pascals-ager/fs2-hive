...
case class ClickWithArray ( `type`: String,
                            id: String,
...
object ClickWithArray {
  ...
  implicit val ClickWithArrayDecoder: Decoder[ClickWithArray] = deriveDecoder[ClickWithArray]
  implicit val ClickWithArrayEncoder: Encoder[ClickWithArray] = deriveEncoder[ClickWithArray]
}