...
case class FlClicksFlattened[F[_]]( `type`: F[String],
                                    id: F[String],
                                    isp: F[String],
                                    service_id: F[Int],
...
object FlClicksFlattened {
  ...
  implicit val OwClicksFlattenedDecoder: Decoder[FlClicksFlattened[Option]] = deriveDecoder[FlClicksFlattened[Option]]
  implicit val OwClicksFlattenedEncoder: Encoder[FlClicksFlattened[Option]] = deriveEncoder[FlClicksFlattened[Option]]
}
