...
case class ClickWithStructArray ( `type`: String,
                                  id: String,
                                  ...
                                  event_data_strategies: Option[List[Strategy]],
                                  year: Int,
                                  month: Int,
                                  day: Int )

object ClickWithStructArray {
  ...
  implicit val ClickWithStructArrayDecoder: Decoder[ClickWithStructArray] = deriveDecoder[ClickWithStructArray]
  implicit val ClickWithStructArrayEncoder: Encoder[ClickWithStructArray] = deriveEncoder[ClickWithStructArray]
}
