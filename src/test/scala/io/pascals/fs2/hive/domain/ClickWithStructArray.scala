...
case class ClickWithStructArray(
    `type`: String,
    id: String,
...
object ClickWithStructArray {
  ...
  implicit val ClickWithStructArrayDecoder: Decoder[ClickWithStructArray] =
    deriveDecoder[ClickWithStructArray]
  implicit val ClickWithStructArrayEncoder: Encoder[ClickWithStructArray] =
    deriveEncoder[ClickWithStructArray]
}
