...
case class FlClicks[F[_], G[_]]( id: F[String],
                                 ts: OffsetDateTime,
                                 isp: F[String],
                                 service_id: F[Int],
...
object FlClicks {
  ...
  implicit val OwClicksDecoder: Decoder[FlClicks[Option, Id]] = deriveDecoder[FlClicks[Option, Id]]
  implicit val OwClicksEncoder: Encoder[FlClicks[Option, Id]] = deriveEncoder[FlClicks[Option, Id]]
}
